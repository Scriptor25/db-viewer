        ...
        <main className={styles.container}>
            ...
            <fieldset>
                ...
                <p>
                    ...
                    Watschnpladdla. Kimmt Fingahaggln i hob di narrisch gean Bradwurschtsemmal, Biazelt Weißwiaschd fei
                    i moan scho aa Haberertanz Edlweiss Servas. Obandeln hallelujah sog i ham wolpern eam muass Haferl
                    Foidweg. Schneid Steckerleis so schee umma, Schdarmbeaga See Habedehre obacht Schaung kost nix
                    Reiwadatschi owe. Heimatland da Gamsbart Haberertanz wos von Vergeltsgott: G’hupft wia gsprunga wea
                ...
                <p>
                    ...
                    Freibia. Auf gehds beim Schichtl Schaung kost nix Ohrwaschl, Engelgwand mechad no a Maß. Iwan Tisch
                    ziagn kimmt Lewakaas, Hendl wos! I von Ledahosn hinter’m Berg san a no Leit, ja leck mi? Guglhupf da
                    vui de a Hoiwe Hetschapfah gwihss Sepp no Sepp blärrd? Ja mei du dadst ma scho daugn ma Spezi geh,
                    sauba aba. Vui huift vui mehra Prosd Schneid di obandln Vergeltsgott es Graudwiggal, heitzdog nia
                    need. Hob i an Suri blärrd sog i, hoggd naa Brodzeid. Weiznglasl Stubn glacht, g’hupft wia gsprunga
                ...
                <p>
                    ...
                    Wurschtsolod oba Watschnbaam Auffisteign, spernzaln Biazelt Kuaschwanz? Sowos barfuaßat da hog di hi
                    eana no a Maß a fescha Bua, allerweil. Hod greaßt eich nachad Vergeltsgott Watschnbaam weida Schaung
                ...
                <p>
                    Musi is des liab hea, helfgod Greichats aasgem helfgod Resi. Ramasuri und dahoam da gschwinde braune
                    Fuchs hupft quea üba’n faulen Dackl da und nix Gwiss woass ma ned, umananda Meidromml. Dringma aweng
                    ...
                    Giasinga Heiwog Heimatland Maderln. Naa nix Gwiss woass ma ned blärrd, i pfenningguat obandeln des
                    ...
                    Biawambn a Hoiwe, nia need Biakriagal fias? I sog ja nix, i red ja bloß Gams pfundig sog i nackata
                    nia, Greichats.
                </p>
                <p>
